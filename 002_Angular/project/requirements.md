...
* Для реализации функционала интерфейса сайта используйте AngularJS.  
...
* Для реализации прокрутки страницы создайте свой сервис AngularJS. 
...
* Создайте директиву-слайдер изображений. 

* В слайдере должно использоваться три слайда с произвольным изображением и текстом.
* Смена слайдов должна присходить с интервалом в 3с. 
* По нажатию стрелок навигации, автоматическая смена слайдов должна приостанавливатся, 
...
* При наведении курсора мыши на иконки сервисов, они плавно увеличиваются в размере на 10% и уменьшаются обратно, 
  когда курсор уходит с элемента (для решения данной задачи используйте AngularJS).
...
* Создайте Angular фильтр для каждой категории с возможностью выбирать нужные изображения.
...
* Реализуйте слайдер с помощью директивы. 
