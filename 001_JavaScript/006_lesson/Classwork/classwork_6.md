...
* Напишите код, который получит объект для тега head.
* Напишите код, который получит объект для тега ul.
* Напишите код, который получит объект для второго тега li. 
